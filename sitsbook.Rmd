...
- [1] Santos, L.A.; Ferreira, K.; Picoli, M.; Camara, G.; Zurita-Milla, R.; Augustijn, E. Identifying Spatiotemporal Patterns in Land Use and Cover Samples from Satellite Image Time Series. Remote Sens. 2021, 13, 974. 
...
Generalizing [@Appel2019], we consider the following definition:
...
2. Use tools that generate regularly spaced cubes in time from image collection, as does the `sits_regularize` funcion in *sits*.
...
tCNN_model <- sits_train(samples_filtered, 
                       sits_TempCNN(
                          ...
                          mlp_activation       = 'elu',
                          mlp_dropout_rates    = c(0.30, 0.20, 0.10),
                          epochs               = 150,
                          batch_size           = 128,
                          validation_split     = 0.2,
                          verbose              = 0) )
